...
setup(name="pyo3-capsule-user",
      ...
      long_description='',
      packages=['pyo3_capsule_user'],
      rust_extensions=[
          RustExtension('pyo3_capsule_user.rust_binding', 'Cargo.toml', binding=Binding.PyO3, debug=True)
      ],
      license='BSD',
      url='https://github.com/fx-kirin/pyo3-capsule-user',
      zip_safe=False,
